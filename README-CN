...
工业革命依靠蒸汽机和机械化的技术突破推动了前所未有的经济和社会繁荣。

在二十世纪，密码学和互联网的兴起改变了沟通和信息获取的方式。个人自由的扩展为数十亿人创造了经济机会。

今天，我们正处在区块链和Web3的黎明时代。就像互联网曾经改变了信息领域一样，Web3正在改变数字所有权和价值交换的格局。它提供了有希望的新型社会组织形式，例如“网络国家”1。

通过密码学革命的浪潮，我们的旅程仍在继续。公钥密码学和区块链标志着第一和第二波浪潮，现在我们面临第三波：零知识证明革命。结合Web3，零知识证明革命将重新定义我们的集体未来，成为技术解锁个人自由力量的明证。

## ZK 革命

![ZK 革命](zk-revolution.jpeg)

"ZK"是一个有两个含义的术语。最初，它代表"零知识证明 Zero-Knowledge (Proofs)"，或者，如果你坚持的话，代表"加密压缩 Zipped by Kryptography"[^2]。如今，"ZK"体现了一个更大的概念，包含了三个特性：完整性、隐私和魔法。

完整性
*"完整性是做正确的事情...即使没有人看到或者知道。"* [^3]

ZK回应了数学、开源和区块链所基于的"不要相信，要验证"的伦理原则。通过递归ZK证明，在任何规模上实现计算完整性，这是这个要素的基石。

隐私
*"在电子时代，隐私对于一个开放的社会是必要的。"* [^4]

在区块链领域，隐私被视为一项基本权利，而这个权利所带来的挑战是ZK所独特应对的。隐私不应该是赐予我们的礼物；它是我们必须共同主张和捍卫的基本权利。
...
> 
> **安全性。** 针对任何单个用户的攻击必须与针对整个网络的攻击一样困难和昂贵，即使对于全球最强大的参与者也是如此。
> 
...
> 
> **主权。** 任何用户群体，甚至是少数用户，都必须有权退出——即从网络中分叉出去，同时以最小的成本带走他们的资产。

目前，以太坊最接近实现将区块链网络成为价值互联网基础的愿景。它是一个无需信任、安全、可靠、抗审查和主权的网络。然而，它目前尚未满足隐私、超大规模扩展性和可访问性的其他先决条件。

通过ZK的魔力，以太坊上的Web3可以成为隐私的堡垒，并实现无限的扩展性，同时保持完整性。在这个变革的状态下，它将成为数字自主权的一个可访问和经济实惠的避风港。
...
ZK原则赋予了一个网络，用户无需信任运营商就能保护他们的资产和控制权。即使伏地魔能够访问我们的服务器，他们也无法损害用户的所有权或控制他们的资产。

然而，技术在不断进化，区块链也在不断演变。单凭技术无法完全保障ZK原则。为确保持久的保护，社区必须深刻拥抱这个难以捉摸的分散化概念。
